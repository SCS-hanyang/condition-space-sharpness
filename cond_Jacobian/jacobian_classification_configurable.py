...
def load_prompts(num_mem=500, num_unmem=500):
...
def main():
    ...
    # Update Output Dir to reflect prompt counts
    dir_name = f"jacobian_classification_proj_{NUM_PROJECTIONS}_m{NUM_MEM_PROMPTS}_u{NUM_UNMEM_PROMPTS}"
    ...
    # 1. Extract Prompts
    mem_prompts, unmem_prompts = load_prompts(NUM_MEM_PROMPTS, NUM_UNMEM_PROMPTS)
