...
class Config:
    seed: int = 42
    out_dir: str = "./results/condition_Jacobian_dynamics_during_training_diff_prompts/"
    ...
    # wandb
    wandb_project: str = "condition_Jacobian_dynamics_during_training_diff_prompts"
